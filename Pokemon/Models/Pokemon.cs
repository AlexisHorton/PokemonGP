...
{
    //public class PokemonAPIList
    //{
    //    public List<PokemonAPIResponse> list { get; set; }
    //}
    ...
    public class PokemonAPI
    {
        ...
        public static async Task<PokemonAPIResponse> GetPokemon()
        {
            for (int i=1; i < 152; i++)
                {
                var connection = await MyHttp.GetAsync($"pokemon/{i}");
                PokemonAPIResponse pokemon2 = await connection.Content.ReadAsAsync<PokemonAPIResponse>();
